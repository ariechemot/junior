...
$sql=mysql_query("select * from instructor order by id_instructor desc")or die("salah");
?>
<center>
...
<tr>
	...
	<td  bgcolor="gray"><center><font color="white"><a href="deleteinstructor.php?id=<?php echo $hasil[0] ?>" title="Delete"><img src="../images/hapus.png" width=25 height=25></a></td>
	<td  bgcolor="gray"><center><font color="white"><a href="editinstructor.php?id=<?php echo $hasil[0] ?>" title="Edit"><img src="../images/edit.png" width=25 height=25></a></td>
